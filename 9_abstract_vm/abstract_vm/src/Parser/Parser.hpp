...
public:
	...
	bool								printExceptions(const std::vector<std::string> &);
...
private:
	...
	std::array<t_sequence, static_cast<size_t>(eTokenType::eof)> 		p_ope_seq;
	std::array<eExceptionType, static_cast<size_t>(eTokenType::eof)> 	p_ex_seq;
